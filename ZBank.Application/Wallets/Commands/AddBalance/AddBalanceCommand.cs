...
public record AddBalanceCommand(UserId UserId, WalletId WalletId, CurrencyId CurrencyId, decimal Amount) : IRequest<ErrorOr<WithNotificationResult<Balance, InformationNotification>>>;