...
public record InformationNotificationResponse(string Content, bool IsRead, string ReceiverId, NotificationSenderResponse NotificationSender);

public record TeamInviteNotificationResponse(string Content, bool IsRead, string ReceiverId, NotificationSenderResponse NotificationSender, NotificationTeamResponse Team);
